      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md p-6 sm:p-7 rounded-2xl bg-[#FFF9F3] border-2 border-[#D4B08C] text-[#854D27] shadow-2xl"
          >
            {/* Header */}
            <div className="flex items-center justify-between pb-3 border-b border-[#D4B08C]/60 mb-4">
              ...
              <button
                ...
                onClick={onClose}
                aria-label={t('close')}
                className="p-2 rounded-xl text-[#854D27] hover:bg-[#FAF0E6] active:scale-[0.96] transition-all cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center focus-visible:ring-2 focus-visible:ring-[#854D27]/40"
              >
                <X size={18} />
              </button>
            </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {AMBIENT_PRESETS.map((preset) => (
                  <button
                    ...
                    className="px-3 py-2.5 rounded-xl bg-white hover:bg-[#FAF0E6] active:scale-[0.96] border border-[#D4B08C] hover:border-[#854D27] text-xs text-[#854D27] transition-all text-center truncate font-semibold cursor-pointer shadow-2xs font-body min-h-[44px] focus-visible:ring-2 focus-visible:ring-[#854D27]/40"
                  >
                    {preset.name}
                  </button>
                ))}
            ...
            <div className="mb-4 p-3.5 rounded-xl bg-white border border-[#D4B08C] shadow-2xs">
              ...
              <input
                ...
                className="w-full h-2 bg-[#D4B08C]/40 rounded-lg appearance-none cursor-pointer accent-[#D95D39] focus-visible:ring-2 focus-visible:ring-[#854D27]/40"
              />
            </div>
            ...
            {/* Footer Actions */}
            <div className="flex items-center justify-between pt-3 border-t border-[#D4B08C]/60">
              <button
                type="button"
                onClick={muteAll}
                className="flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl text-xs text-[#854D27]/70 hover:text-[#854D27] hover:bg-[#FAF0E6] active:scale-[0.96] transition-all font-semibold cursor-pointer font-body min-h-[44px] focus-visible:ring-2 focus-visible:ring-[#854D27]/40"
              >
                <RotateCcw size={14} />
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold active:scale-[0.96] transition-all shadow-xs cursor-pointer font-body min-h-[44px] focus-visible:ring-2 focus-visible:ring-[#854D27]/40 ${
                  isPlaying
